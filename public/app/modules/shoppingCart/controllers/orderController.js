...
angular.module('shoppingCart')
    .controller('OrderController', ['$scope', '$state', 'ShoppingCart', 'Identity', 'StatelineFactory',
        function OrderController ($scope, $state, ShoppingCart, Identity, StatelineFactory) {
            ...
            //});
            //
            //self.isStateCompleted = function isStateCompleted (state, states, completedStates) {
            ...
            //};
            //
            //self.completeState = function completeState (states, callback) {
            ...
            //                }
            //                else {
            //                    // TODO: Delete me when the Stateline service is ready
            ...
            //};
            //
            //self.isDisabled = function isDisabled (stateName, activeState) {
